...
private:
	...
	template <class C>
	bool iterateRecursion(AccControlItem * parent, C* callbackObj, bool (C::*callbackFunction)(IControlItem * node, void * userData), void * userData, bool fromLast)
	{
		long obtained = 0;
		long child_count = 0;
		HRESULT hresult;
